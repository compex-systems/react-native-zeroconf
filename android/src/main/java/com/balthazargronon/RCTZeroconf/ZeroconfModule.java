...
public class ZeroconfModule extends ReactContextBaseJavaModule {
    ...
    public static final String EVENT_UPDATE = "RNZeroconfUpdate";
    ...
    protected MulticastThread multicastThread = null;
    ...
    public void scan(String type, String protocol, String domain) {
        ...
        if (multicastThread != null) {
            multicastThread.submitQuit();
        }
        multicastThread = new MulticastThread(getReactApplicationContext());
        multicastThread.start();
        multicastThread.submitQuery(String.format("_%s._%s.local", type, protocol));
